package com.spazzy.ChocolateFactory.container;

import com.spazzy.ChocolateFactory.handler.CocoaDryerRecpies;
...
public class ContainerCocoaDryer extends Container {
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int par2){
		...
		if(slot != null && slot.getHasStack()){
			...
			if(par2 == 2){
				...
				if(CocoaDryerRecpies.smelting().getSmeltingResult(itemstack1) != null){
					if(!this.mergeItemStack(itemstack1, 0, 1, false)){
						return null;
					}
				}else if(TileEntityCocoaDryer.isItemFuel(itemstack1)){
