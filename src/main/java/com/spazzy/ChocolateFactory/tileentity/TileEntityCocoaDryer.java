package com.spazzy.ChocolateFactory.tileentity;
...
public class TileEntityCocoaDryer extends TileEntity implements ISidedInventory {
	...
	private boolean canSmelt() {
		if (this.furnaceItemStacks[0] == null) {
			...
			ItemStack itemstack = CocoaDryerRecpies.smelting().getSmeltingResult(this.furnaceItemStacks[0]);
