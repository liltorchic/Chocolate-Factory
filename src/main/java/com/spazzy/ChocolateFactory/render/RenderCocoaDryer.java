...
import cpw.mods.fml.client.registry.ISimpleBlockRenderingHandler;
	...
	public class RenderCocoaDryer implements ISimpleBlockRenderingHandler
	{
		public static final RenderCocoaDryer INSTANCE = new RenderCocoaDryer();
		@Override
		public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer)
		{
			int meta=3;
			if(block == CocoaBlocks.cocoaDryer) meta=1;
			/*
