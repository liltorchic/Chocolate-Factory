...
public class GuiCocoaDryer extends GuiContainer{

	private static final ResourceLocation furnaceGuiTextures = new ResourceLocation(Reference.MODID.toLowerCase() + ":textures/gui/dryer.png");
	private TileEntityCocoaDryer tileFurnace;

	public GuiCocoaDryer(InventoryPlayer invPlayer, TileEntityCocoaDryer tile) {
		super(new ContainerCocoaDryer(invPlayer, tile));
